  ...
  static const Map<String, Map<String, String>> _messageMap = {
    "en": {
      ...
      "auth-visit-site-guide":
          "To explore in-depth instructions for utilizing this rapid starter Flutter project, head over to https://github.com/midhunarmid/docfinder to kick off your journey.",
    }
  };
